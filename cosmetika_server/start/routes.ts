...
router.post('/fournisseur-invoices-items', [FournisseurInvoiceItemsController, 'store'])
router.get('/fournisseur-invoices-items/:invoiceId', [FournisseurInvoiceItemsController, 'index'])
router.delete('/fournisseur-invoices-items/:invoiceId/:itemNo', [FournisseurInvoiceItemsController, 'destroy'])